...
int main()
{
   ...
   accounts[ 0 ] = &SavingsAccount(25.0, .03);    //new SavingsAccount( 25.0, .03 ); 
   ...
   for ( size_t i = 0; i < accounts.size(); i++ )
   {
	  ...
	  cout << accounts[i]->debit(withdrawalAmount);
      ...
      if (savingsAccountPtr!=nullptr)
      {
		  double interestEarned = savingsAccountPtr->calculateInterest();
			 /* Call member function calculateInterest
