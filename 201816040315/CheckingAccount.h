...
public:
  ...
  virtual void credit( double );//virtual function credit for class CheckingAccount
   /* Write a function prototype for virtual function debit,
      which will redefine the inherited debit function */
  virtual bool debit( double );//virtual function debit for class  CheckingAccount
private:
